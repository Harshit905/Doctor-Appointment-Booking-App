...
function validateStudentRegisterInput(data) {
    let errors = {};
    ...
    if (Validator.isEmpty(data.registration)) {
        errors.password = "Registration field is required";
    }
    if (Validator.isEmpty(data.enroll)) {
        errors.password = "Enrollment field is required";
    }
...
function validateTeacherRegisterInput(data) {
    let errors = {};
  // Convert empty fields to an empty string so we can use validator functions
    data.name = !isEmpty(data.name) ? data.name : "";
    data.email = !isEmpty(data.email) ? data.email : "";
